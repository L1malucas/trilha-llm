...
> Conteúdo acadêmico com prática de código, focado em ferramentas e conteúdo open-source. Usa Python e/ou TypeScript quando faz sentido. Este é o mapa da versão **original** — a referência rápida da trilha, um arquivo por módulo.

Esta trilha existe em 3 versões: **v1** (conteúdo original, formato checklist — esta que você está lendo agora), **v2** (mais teórica, Clássico) e **v3** (mais prática, Acelerado). Troque entre elas pelo seletor de versão no topo do site; a seção "Outras versões desta trilha", mais abaixo, explica cada uma em detalhe.
...
Uma regra vale a trilha inteira: todo conceito teórico precisa virar código pelo menos uma vez. Implementar do zero, mesmo que saia torto, ensina mais do que só reconhecer o conceito depois. Esta versão é o checklist — tópicos e referências, sem o aprofundamento guiado das outras duas.

---

## Outras versões desta trilha

Esta é a versão **Checklist** — mais enxuta, sem explicação aprofundada nem projetos guiados com código, útil como mapa de referência rápida. Se você está começando agora, ou quer teoria e projetos completos, existem duas outras versões, trocáveis pelo seletor de versão no topo do site: [v2 — Clássico](/trilha-llm/v2/) (teoria completa antes da prática, ordem 01→20) e [v3 — Acelerado](/trilha-llm/) (prática primeiro, ordem 08→20 depois 7→1).
